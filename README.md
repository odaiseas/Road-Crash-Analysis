...
- Смоделированы факторы, влияющие на число погибших в ДТП с использование счетных моделей и дерева решений

## Следующие шаги:

**Статистическое моделирование**  
  - Для задачи классификации ("есть погибшие / нет") будет применена дополнительная модель бинарной классификации: **случайный лес**".
